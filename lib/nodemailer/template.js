                        ...
                        <td class="mobile-padding" style="padding: 0 40px 40px 40px;">
                            ...
                            <div style="text-align: center; margin: 40px 0 0 0;">
                                ...
                                <p style="font-size: 14px; color: #CCDADC;">
                                    ...
                                    <a href="https://signalist.app" style="color: #CCDADC;">Visit Signalist</a>
                                </p>
                                <p style="font-size: 14px; color: #CCDADC;">
                                    © 2025 Signalist
                                </p>
        ...
        <tr>
            <td align="center" class="mobile-outer-padding" style="padding: 40px 20px;">
                <table role="presentation" width="100%" class="email-container" style="max-width: 600px; background-color: #141414; border-radius: 8px; border: 1px solid #30333A;">
                    ...
                    <tr>
                        <td align="left" class="mobile-header-padding" style="padding: 40px 40px 20px 40px;">
                            <img src="https://ik.imagekit.io/a6fkjou7d/logo.png?updatedAt=1756378431634" alt="Signalist Logo" width="150">
                        </td>
                    </tr>
        ...
        <tr>
            <td align="center" class="mobile-outer-padding" style="padding: 40px 20px;">
                <table role="presentation" width="100%" class="email-container" style="max-width: 600px; background-color: #141414; border-radius: 8px; border: 1px solid #30333A;">
                    ...
                    <tr>
                        <td align="left" class="mobile-header-padding" style="padding: 40px 40px 20px;">
                            <img src="https://ik.imagekit.io/a6fkjou7d/logo.png?updatedAt=1756378431634" width="150" alt="Signalist Logo">
                        </td>
                    </tr>
                        ...
                        <td class="mobile-padding" style="padding: 40px;">
                            ...
                            <div style="text-align: center; margin-top: 40px;">
                                ...
                                <p style="margin: 0 0 10px; font-size: 14px; color: #CCDADC;">
                                    ...
                                    <a href="{{dashboardUrl}}" style="color: #CCDADC; text-decoration: underline;">Visit Signalist</a>
                                </p>
                                <p style="margin: 0; font-size: 14px; color: #CCDADC;">
                                    © 2025 Signalist
                                </p>
