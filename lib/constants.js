...
export const CANDLE_CHART_WIDGET_CONFIG = (symbol) => ({
...
export const BASELINE_WIDGET_CONFIG = (symbol) => ({
    allow_symbol_change: false,
    calendar: false,
    details: false,
    hide_side_toolbar: true,
...
export const POPULAR_STOCK_SYMBOLS = [
    ...
    'SPOT', 'SQ', 'SHOP', 'ROKU', 'SNOW', 'PLTR', 'COIN', 'RBLX',
    'DDOG', 'CRWD', 'NET', 'OKTA', 'TWLO', 'ZM', 'DOCU', 'PTON',
    'PINS', 'SNAP', 'LYFT', 'DASH', 'ABNB', 'RIVN', 'LCID', 'NIO',
    'XPEV', 'LI', 'BABA', 'JD', 'PDD', 'TME', 'BILI', 'DIDI',
    'GRAB', 'SE',
];
